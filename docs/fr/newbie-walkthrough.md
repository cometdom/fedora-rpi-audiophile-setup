...
> 🇬🇧 This page is also available in **[English](../en/newbie-walkthrough.md)** — or as a [PDF](https://github.com/cometdom/fedora-rpi-audiophile-setup/releases/latest/download/newbie-walkthrough-en.pdf).
> 🇫🇷 Version PDF de cette page française : [newbie-walkthrough-fr.pdf](https://github.com/cometdom/fedora-rpi-audiophile-setup/releases/latest/download/newbie-walkthrough-fr.pdf).
...
| 10 install-drup | Menu **version de FFmpeg** de l'`install.sh` de DRUP | **2 = FFmpeg 7.1.1 minimal** sur le Pi. Empreinte minimale, plus facile sur les cartes peu en RAM. L'option 3 (8.1.2 minimal, défaut) peut aussi fonctionner depuis que le problème de configure a été corrigé en v2.5.7, mais la 7.1.1 minimal reste le choix le plus sûr sur Pi. (L'assistant affiche ce rappel juste avant de lancer l'installeur.) |
